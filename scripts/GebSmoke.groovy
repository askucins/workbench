...
@Grapes([
    ...
    @Grab("org.seleniumhq.selenium:selenium-support:4.38.0"),
    @Grab("org.seleniumhq.selenium:selenium-chrome-driver:4.38.0"),
    @Grab("org.seleniumhq.selenium:selenium-devtools-v142:4.38.0"),
