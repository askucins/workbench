...
@Grapes([
    ...
    @Grab("org.seleniumhq.selenium:selenium-support:4.43.0"),
    @Grab("org.seleniumhq.selenium:selenium-chrome-driver:4.43.0"),
    @Grab("org.seleniumhq.selenium:selenium-devtools-v147:4.43.0"),
