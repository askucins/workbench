...
@Grapes([
    ...
    @Grab("org.seleniumhq.selenium:selenium-support:4.39.0"),
    @Grab("org.seleniumhq.selenium:selenium-chrome-driver:4.39.0"),
    @Grab("org.seleniumhq.selenium:selenium-devtools-v143:4.39.0"),
